...
# testcases = [
# Dict(:dist => D.Normal(-5.0, 3.0), # 1D normal dist
#      :theta0 => -4.0,
#      :ball_radius => 0.1,
#      :nwalkers => 100,
#      :niter => 10^4,
#      :hasblob => false,
#      :sample_ppdf => theta -> 10*randn() + theta,
#      :tole => 0.2,
#      :tolm => 0.2,
#      ),
# Dict(:dist => D.LogNormal(0, 1.0), # 1D log-normal dist
#      :theta0 => 0.4,
#      :ball_radius => 0.1,
#      :nwalkers => 100,
#      :niter => 10^7,
...
#      :tolm => 0.3
#      ),
# Dict(:dist => D.MvNormal([0.5,-0.25], [0.47 1.8
#                                        1.8 7.]), # 2D normal dist
#      :theta0 => [0.4, 0.3],
#      :ball_radius => 0.1,
#      :nwalkers => 100,
